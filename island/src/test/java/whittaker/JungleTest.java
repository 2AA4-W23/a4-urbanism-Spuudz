...
public class JungleTest {
    ...
    public void genWhittaker(){
        ...
        island=jungle.genWhittaker(island);
        assertEquals("montane",(island.getTiles(0).getProperties().get("tile_type")));
        assertEquals("tropical",island.getTiles(1).getProperties().get("tile_type"));
        assertEquals("tropical",(island.getTiles(2).getProperties().get("tile_type")));
